...
urlpatterns = [
    ...
    path('<uuid:uuid>/permissions/', FilePermissionView.as_view(), name='file-permission'),
    ...
    path('shared-with-team/<int:team_id>/', FilesSharedWithTeamView.as_view(), name='files-shared-with-team'),
    path('shared-with-user/', FilesSharedWithUserView.as_view(), name='files-shared-with-user'),
    path('shared-with-user-teams/', FilesSharedWithUserTeamsView.as_view(), name='files-shared-with-user-teams'),
]
